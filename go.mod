...
require (
	...
	github.com/wowchemy/wowchemy-hugo-themes/modules/wowchemy v5.6.0 
)
...
replace github.com/wowchemy/wowchemy-hugo-themes/modules/wowchemy v5.6.0 => github.com/tonyonbox3/wowchemy-hugo-themes/modules/wowchemy v0.0.0 
